...
const CATEGORY_SLUG = "giay-dep";
// Link banner từ ảnh image_19081b.jpg bạn đã gửi
const BANNER_IMG =
  "https://cdn.hstatic.net/files/1000360022/collection/dep_df6d9dfce0d84734a7a7219f6665a599.jpg";
...
const GiayDepPage = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      {/* SECTION 2: BANNER LỚN (Đúng theo ảnh image_19081b.jpg) */}
      ...
      {/* SECTION 3: TOOLBAR (Đã loại bỏ hàng icon subCategory) */}
      <div style={styles.toolbar}>
        <div style={styles.countText}>
          Có <strong>{sortedProducts.length}</strong> sản phẩm phù hợp
        </div>
      ...
      <div style={styles.seoBox}>
        ...
        <p style={styles.seoDesc}>
          Khám phá những thiết kế {CATEGORY_NAME.toLowerCase()} nam tính, hiện
          đại và bền bỉ. Phù hợp cho mọi nhu cầu từ đi làm, đi chơi đến dạo phố.
        </p>
      </div>
