...
// --- CẤU HÌNH RIÊNG CHO DANH MỤC VỚ ---
const CATEGORY_NAME = "";
const CATEGORY_SUBTITLE = "";
const CATEGORY_SLUG = "vo";
// Link banner cho Vớ/Tất nam
const BANNER_IMG =
  "https://cdn.hstatic.net/files/1000360022/collection/vo_8c6ca4b55eeb45969c87352794e11c09.jpg";
...
const VoPage = () => {
  ...
  // 1. Lọc sản phẩm theo Slug danh mục vo
    ...
    <div style={styles.container}>
      ...
      <div style={styles.toolbar}>
        <div style={styles.countText}>
          Có <strong>{sortedProducts.length}</strong> mẫu vớ nam cao cấp
        </div>
      ...
      <div style={styles.productGrid}>
        {sortedProducts.length > 0 ? (
          ...
          <div style={styles.noProduct}>Đang cập nhật thêm nhiều mẫu mới.</div>
        )}
      </div>

      {/* SECTION 5: SEO BOX */}
      <div style={styles.seoBox}>
        <h2 style={styles.seoHeading}>Vớ Nam Cao Cấp - Êm Ái & Kháng Khuẩn</h2>
        <p style={styles.seoDesc}>
          Bảo vệ đôi chân và hoàn thiện phong cách với các dòng vớ (tất) nam từ
          DIEP COLLECTION. Sử dụng chất liệu Cotton Bamboo mềm mịn, thấm hút mồ
          hôi cực tốt và công nghệ kháng khuẩn vượt trội, mang lại cảm giác
